...
function createInstance(){
    ...
    for(let i = 0; i < user_choice.value; i++){
        counter++;
        box.innerHTML +=  
        `<input class="select course" type="text" placeholder="Course code" id="courseRow${counter}" required="true">
        
        <input class="select units" type="number" placeholder="Course units" id="unitRow${counter}" required="true">
    ...
    box.innerHTML += `<input type="submit" value="submit" class="chi-btn" onclick="getGPA()">`;
